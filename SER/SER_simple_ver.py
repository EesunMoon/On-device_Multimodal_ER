...
class SpeechEmotionRecognition:
    def __init__(self):
        ...
        self.confusion_prefix       = 'result_conf_ser'
        self.EPOCH                  = 50
        self.BATCH_SIZE             = 64
        self.drop_rate              = 0.5
    ...
    def ModelTrain(self,X_train, X_val, y_train, y_val, model_dim, model_filename, history_filename):
        """
        ...
        pd.DataFrame(self.history.history).to_csv(path_or_buf = history_filename)
    ...
    def StartModelProcess(self, model_dim, model_filename, history_filename):
        ...
        self.ModelTrain(X_train, X_val, y_train, y_val, 
                        ...
                        os.path.join(self.model_dir, history_filename))
...
if __name__ == "__main__":
    ...
    history_filename = 'history_'
    history_filename = history_filename + str(model_dim) + '.csv'
    ser.StartModelProcess(model_dim, model_filename, history_filename)
